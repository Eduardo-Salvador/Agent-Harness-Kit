...
| ID | Goal | Depends on | Status | Owner | Paths | Checkpoint | Assurance requires |
| --- | --- | --- | --- | --- | --- | --- | --- |
| TASK-001 | Add contract validator | — | active | agent:builder-1 | `src/contracts/**`, `tests/contracts/**` | no | — |
| TASK-002 | Integrate validator with runtime | TASK-001 | pending | — | `src/runtime/**`, `tests/runtime/**` | no | TASK-001 |
