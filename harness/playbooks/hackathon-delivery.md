...
4. Run `writing-plans` in compressed form. Use compact inline specs where sufficient; otherwise target 15–30-minute units around the smallest end-to-end demo slice and justify exceptions.
