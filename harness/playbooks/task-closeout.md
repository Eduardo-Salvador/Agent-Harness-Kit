...
4. Give the user the compact closeout from [status and completion communication](../../docs/STATUS-AND-COMPLETION.md): outcome, material changes, checks, `completed`, next task/action, and human action required.
