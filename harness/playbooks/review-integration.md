...
8. On round 2 `changes-requested`, stop the review loop. Block and escalate/decompose the remediation or affected integration path, not the already completed historical node or unrelated project execution. Request a human decision only for a genuine product/risk conflict.
