...
4. Select `delivery`, `delivery+learning`, `hackathon`, or `hackathon+learning`, obtain explicit human dispositions, and pin the approved context revision. Hackathon modes use the compressed demo-first playbook; the separate Harness Engineering Learning Pack is not a runtime selection.
