...
6. Run [writing plans](writing-plans.md). Classify truly simple work for a compact inline spec; otherwise create one implementation plan with two-to-five-minute executable units and generate a self-contained task spec for each unit.
