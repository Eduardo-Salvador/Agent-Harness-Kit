...
2. Interview adaptively under [the discovery protocol](../../docs/DISCOVERY-INTERVIEW.md). After product intent, resolve architecture and folder organization from approved context or repository evidence; ask only for unresolved choices and let the user request a recommendation. Record optional coding conventions as detected, user-specified, stack-defaults-approved, or none.
