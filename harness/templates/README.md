...
| [Review result](REVIEW.md) | Fresh-context independent reviewer; SPEC-led initial review plus at most one focused re-review |
...
| [Parallel dispatch](PARALLEL-DISPATCH.md) | Orchestrator records collision-safe batch selection, actual launches, first-event refill, and fan-in |
