...
- For frontend-screen work, inventory `design-taste-frontend`, `imagegen-frontend-web`, `imagegen`, and `image-to-code` separately; the router must degrade visibly when any phase capability is absent.
